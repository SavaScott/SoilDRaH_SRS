...
readsource.file <- '../../../R/readBinkley1999.R'
...
studyMeta <- tribble(~of_variable, ~is_type, ~with_entry, ~from_source,
                     'region', 'site', '13 km NNE of downtown Hilo', paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')),
                     'region', 'state', 'HI', paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')),
                'geolocation', 'latitude', as.character(19 + 50/60 + 28.1/3600), paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')),
                 'geolocation', 'longitude', as.character(-1*(155 + 7/60 + 28.3/3600)), paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')),
               'air_temperature', 'value', '21',paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')),
                'air_temperature', 'unit', '°C',paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')),
               'rainfall', 'min', '300', paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')),
                'rainfall', 'max', '400', paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')),
                'rainfall', 'unit', 'mm mo<sup>-1</sup>', paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')),
              ...
              'observation_time', 'value', '1997', paste('Method ln23:', data.lvl0.df$method[23]),
                'soil_sample_prep', 'method', 'oven dried at 100 C to constant weight', paste('Method ln22:', data.lvl0.df$method[22]),
                'soil_sampling', 'description', '30 by 30 m plots with trees at two spacings (1 by 1 m and 3 by 3 m)', paste('Method ln12:', data.lvl0.df$method[12]),
                'stand_type', 'value', 'E. saligna', paste('Method ln3:', data.lvl0.df$method[3]),
...
Table1Meta <- Table1Primary |>
  ...
  tribble(~of_variable, ~method, ~from_source,
          'soil_ph', paste0(data.lvl0.df$method[25:26], collapse = ' '), 'Methods ln25-26',
          'soil_calcium', paste0(data.lvl0.df$method[27], collapse = ' '), 'Methods ln27',
          'soil_magensium', paste0(data.lvl0.df$method[27], collapse = ' '), 'Methods ln27',
          'soil_aluminum', paste0(data.lvl0.df$method[27], collapse = ' '), 'Methods ln27',
          'soil_potassium', paste0(data.lvl0.df$method[c(14:15,27)], collapse = ' '), 'Methods ln14-15;27',
  'soil_potassium', paste0(data.lvl0.df$method[c(16:17,27)], collapse = ' '), 'Methods ln16-17;27',
  'stand_age', paste0(data.lvl0.df$method[11], collapse = ' '), 'Methods ln11',
  'layer', paste0(data.lvl0.df$method[c(19:20,23:24)], collapse = ' '), 'Methods ln 19-20;23-24',
  'soil_organic_carbon', paste0(data.lvl0.df$method[29:30], collapse = ' '), 'Methods ln 29-30',
  'soil_nitrogen', paste0(data.lvl0.df$method[29:30], collapse = ' '), 'Methods ln 29-30') ) |>
bind_rows(
