...
+ nitrogen_density
+ soil_pH_calcium_chloride
+ soil_calcium
+ soil_magnesium
+ soil_control_potassium
+ soil_fertilized_potassium
+ soil_aluminum
...
studyMeta <- tribble(~of_variable, ~is_type, ~with_entry, ~from_source,
                ...
                'sampling_method', 'description', '30 by 30 m plots with trees at two spacings (1 by 1 m and 3 by 3 m)', paste('Method ln12:', data.lvl0.df$method[12]),
...
Table1Primary <- data.lvl0.df$data$Table1$primary |>
   ...
   pivot_longer(cols = -row_id,
    ...
    mutate(of_variable = case_when(
      ...
      column_name == "Mg (mmol m<sup>-2</sup>)" ~ "soil_magnesium",
      column_name == "C K† (mmol m<sup>-2</sup>)" ~ "soil_control_potassium",
      column_name == "F K† (mmol m<sup>-2</sup>)" ~ "soil_fertilized_potassium",
...
Table1Meta <- Table1Primary |>
  ...
  tribble(~of_variable, ~method, ~from_source,
          ...
          'soil_magnesium', paste0(data.lvl0.df$method[27], collapse = ' '), 'Methods ln27',
          'soil_aluminum', paste0(data.lvl0.df$method[27], collapse = ' '), 'Methods ln27',
          'soil_control_potassium', paste0(data.lvl0.df$method[c(14:15,27)], collapse = ' '), 'Methods ln14-15;27',
  'soil_fertilized_potassium', paste0(data.lvl0.df$method[c(16:17,27)], collapse = ' '), 'Methods ln16-17;27',
