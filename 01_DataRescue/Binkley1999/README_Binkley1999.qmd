...
studyMeta <- tribble(~of_variable, ~is_type, ~with_entry, ~from_source,
                ...
                'air_temperature', 'unit', 'mean',paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')),
                ...
                'rainfall', 'unit', 'mean', paste('Method ln3:', paste(data.lvl0.df$method[3], collapse = ' ')),
...
#Still working on table 1, only one issue with the 95% CI
