...
format:
  html:
    toc: true
    eval: true #if you want to not evaluate the chunks and just check the rendering, switch this to false
date: last-modified
...
- [Qasemian2014_Figure2.csv](Qasemian2014_Figure2.csv)
  + figure 2 from primary article with ...
...
- [Qasemian2014_Figure4.csv](Qasemian2014_Figure4.csv)
  + figure 4 from primary article with ...
- [temp/](temp/)
...
+ Lead
  ...
  - [ ] Create a fresh fork of the primary repository https://github.com/ktoddbrown/SoilDRaH/tree/main, it might be useful to rename it 'SoilDRaH_Qasemian2014'
  - [ ] Create a copy of this template folder and rename it to Qasemian2014
...
Figure M was modified ....

```{r}
#| label: figure2Check
#| eval: false

plot.df <- read_csv(file = figureM.file, #read in the specific file
...
ggplot(data = plot.df, 
  ...
  scale_x_reverse() +
  coord_flip() +
  labs(caption = read_csv(file = tableN.file, #read in that file again but...
...
diff --strip-trailing-cr --suppress-common-lines -y temp/Qasemian2014_FigureM_AC.csv Qasemian2014_FigureM.csv
```
...
Table N was modified by dropping the sub-table as a leading column into the transcribed table.
...
diff --strip-trailing-cr --suppress-common-lines -y temp/Qasemian2014_TableN_AC.csv Qasemian2014_TableN.csv
```
...
diff --strip-trailing-cr --suppress-common-lines -y temp/Qasemian2014_Methods_AC.md Qasemian2014_Methods.md
```
