...
studyMeta <- tribble(~of_variable, ~is_type, ~with_entry, ~from_source,
                   ...
                   'elevation_start', 'value', '850', paste('Method ln8:', paste(data.lvl0.df$method[8], collapse = ' ')),
                   'elevation_end', 'value', '1100', paste('Method ln8:', paste(data.lvl0.df$method[8], collapse = ' ')),
                   'elevation_end', 'unit', 'm', paste('Method ln8:', paste(data.lvl0.df$method[8], collapse = ' ')),
                   'elevation_start', 'unit', 'm', paste('Method ln8:', paste(data.lvl0.df$method[8], collapse = ' ')),
                   'soil_age', 'minimum', '2500', paste('Method ln6:', paste(data.lvl0.df$method[6], collapse = ' ')),
                   'soil_age', 'maximum', '3500', paste('Method ln6:', paste(data.lvl0.df$method[6], collapse = ' ')),
                   'soil_age', 'unit', 'yrs', paste('Method ln6:', paste(data.lvl0.df$method[6], collapse = ' ')),
                   'precipitation', 'minimum', '625', paste('Method ln7:', paste(data.lvl0.df$method[7], collapse = ' ')),
                   'precipitation', 'maximum', '900', paste('Method ln7:', paste(data.lvl0.df$method[7], collapse = ' ')),
                   ...
                   'transect_size', 'value', '1000',   paste('Method ln57:', paste(data.lvl0.df$method[57], collapse = ' ')),
                                      'transect_size', 'unit', 'm',   paste('Method ln57:', paste(data.lvl0.df$method[57], collapse = ' ')),
                   'transect_distance', 'value', '25', paste('Method ln74:', paste(data.lvl0.df$method[74], collapse = ' ')),
                   'transect_distance', 'unit', 'm',paste('Method ln74:', paste(data.lvl0.df$method[74], collapse = ' ')),
'core_comment', 'value', 'soil cores were collected at 25 m intervals close to the grazing center, and spaced to 50 and 100 m further from the center',  paste('Method ln74:', paste(data.lvl0.df$method[74], collapse = ' ')) )
#### Table 1 ####
  ...
  from_source = 'Table 1 column names.') |>
   ...
   bind_rows(
    tribble(~of_variable, ~method, ~from_source,
           ...
           'soil_organic_carbon',  paste0(data.lvl0.df$method[c(94, 96, 98)], collapse = ' '), 'Methods ln94;96;98') |>
...
new_variables <- lapply(data.lvl1.df, function(xx){
...
if(file.exists(readsource.file)){
  datafunction.lvl1.df <- readElmore2006(dataDir = '.',
                                       dataLevel = 'level1')
