...
- [Elmore2006_Table1.csv](Elmore2006_Table1.csv)
  + table 1 from primary article with  Soil data collected along gradients in grazing intensity (G) and elevation (E).
...
studyMeta <- tribble(~of_variable, ~is_type, ~with_entry, ~from_source,
                   ...
                   'transect', 'value', '1000',   paste('Method ln57:', paste(data.lvl0.df$method[57], collapse = ' ')),
                                      'transect', 'unit', 'm',   paste('Method ln57:', paste(data.lvl0.df$method[57], collapse = ' ')),
                                      'soil_sampling', 'value', 'soil cores were collected at 25 m intervals close to the grazing center, and spaced to 50 and 100 m further from the center',  paste('Method ln74:', paste(data.lvl0.df$method[74], collapse = ' ')) )
